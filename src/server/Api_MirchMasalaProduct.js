...
export const MirchMasalaProduct = [
    {
        ...
        discountedPrice: 159,
        rating: 4.5,
        imageUrls: [pizzaImage, pizzaImage],
        keyWords: ['Pizza', '8 inch', 'Farmhouse'],
        variableProductsId: [1, 2],
        spacel: 'New Arrivals',
        available: true,
        categoryId: 2,
        category: ['Pizza', '8 inch', 'Farmhouse'],
        del: 'offer',
    ...
    },
    {
        ...
        available: true,
        categoryId: 2,
        category: ['Pizza', '10 inch', 'Farmhouse'],
        del: 'offer',
    },
    {
        id: 3,
    ...
    },
    {
        ...
        available: true,
        categoryId: 2,
        category: ['Pizza', '10 inch', 'Mushroom'],
        del: 'offer',
    },
    {
        id: 5,
        ...
        available: true,
        categoryId: 2,
        category: ['Pizza', '8 inch', 'Peri Peri Paneer'],
        del: 'offer',
    },
    {
        id: 6,
        ...
        available: true,
        categoryId: 2,
        category: ['Pizza', '10 inch', 'Peri Peri Paneer'],
        del: 'offer',
    },
    {
        id: 7,
        ...
        available: true,
        categoryId: 2,
        category: ['Pizza', '8 inch', 'Paneer Tikka'],
        del: 'offer',
    },
    {
        id: 8,
        ...
        rating: 4.5,
        imageUrls: [pizzaImage, pizzaImage],
        keyWords: ['Pizza', '10 inch', 'Paneer Tikka'],
        variableProductsId: [7, 8],
        spacel: '',
        available: true,
        categoryId: 2,
        category: ['Pizza', '10 inch', 'Paneer Tikka'],
        del: 'offer',
    },
    {
        id: 9,
        ...
        available: true,
        categoryId: 2,
        category: ['Pizza', '8 inch', 'Paneer Makhni'],
        del: 'offer',
    },
    {
        id: 10,
        ...
        available: true,
        categoryId: 2,
        category: ['Pizza', '10 inch', 'Paneer Makhni'],
        del: 'offer',
    },
    {
        id: 11,
        ...
        available: true,
        categoryId: 2,
        category: ['Pizza', '8 inch', 'Schezwan Paneer'],
        del: 'offer',
    },
    {
        id: 12,
        ...
        available: true,
        categoryId: 2,
        category: ['Pizza', '10 inch', 'Schezwan Paneer'],
        del: 'offer',
    },
    {
        id: 13,
    ...
    },
    {
        ...
        available: true,
        categoryId: 3,
        category: ['Burger', 'Paneer Makhani'],
        del: '',
    },
    {
        id: 16,
    ...
    },
    {
        ...
        variableProductsId: [16,17,18],
        spacel: 'Limited Edition',
        available: true,
        categoryId: 4,
        category: ['Combo', 'Spicy Veg'],
        del: 'offer',
    },
    {
        id: 18,
